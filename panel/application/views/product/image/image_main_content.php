<section class="content">
	<div class="row">
		<div class="col-md-12">
		<form action="<?php echo base_url("product/upload_image");?>" class="dropzone"></form>
		</div>
	</div> 
...
<div class="box">
	<div class="box-body table-responsive no-padding">
		<table class="table table-hover">
			...
			<tbody class="sortableList" postUrl="product/productImageRankUpdate">
...
<!--
			...
			-->
					<td>
						<a href="<?php echo base_url("product/deleteImage/$row->id"); ?>">
